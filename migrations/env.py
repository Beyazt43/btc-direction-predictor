...
from btcpred.db.tables import metadata
...
# Migrations stay hand-written; this metadata is here so `alembic check` can
# detect drift between the applied schema and what the code expects.
